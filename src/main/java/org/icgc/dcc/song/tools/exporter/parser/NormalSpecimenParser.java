...
import lombok.val;
import org.icgc.dcc.song.tools.exporter.resolvers.SpecimenClasses;

import static org.icgc.dcc.song.tools.exporter.parser.FieldNames.ANALYZED_ID;
import static org.icgc.dcc.song.tools.exporter.parser.FieldNames.ID;
import static org.icgc.dcc.song.tools.exporter.parser.FieldNames.SAMPLES;
import static org.icgc.dcc.song.tools.exporter.parser.FieldNames.SUBMITTED_ID;
import static org.icgc.dcc.song.tools.exporter.parser.FieldNames.TYPE;
import static org.icgc.dcc.song.tools.exporter.resolvers.SpecimenClasses.NORMAL;
